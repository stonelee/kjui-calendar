...
/*jshint expr:true*/
define("kjui/calendar/1.0.0/calendar-debug", [ "$-debug", "gallery/moment/2.0.0/moment-debug", "gallery/handlebars/1.0.0/handlebars-debug", "kjui/calendar/1.0.0/lang-debug", "arale/tip/1.1.1/tip-debug", "arale/popup/1.0.2/popup-debug", "arale/overlay/1.0.1/overlay-debug", "arale/position/1.0.0/position-debug", "arale/iframe-shim/1.0.1/iframe-shim-debug", "arale/widget/1.0.3/widget-debug", "arale/base/1.0.1/base-debug", "arale/class/1.0.0/class-debug", "arale/events/1.0.0/events-debug", "arale/calendar/0.8.5/calendar-debug", "arale/widget/1.0.3/templatable-debug" ], function(require, exports, module) {
    var $ = require("$-debug"), moment = require("gallery/moment/2.0.0/moment-debug"), Handlebars = require("gallery/handlebars/1.0.0/handlebars-debug"), lang = require("kjui/calendar/1.0.0/lang-debug"), Tip = require("arale/tip/1.1.1/tip-debug"), AraleCalendar = require("arale/calendar/0.8.5/calendar-debug");
    ...
    var Calendar = PatchCalendar.extend({
        attrs: {
            ...
            target: null,
            template: require("kjui/calendar/1.0.0/calendar-debug.tpl"),
            startDay: 1,
            needTime: false,
            needHour: true,
            needMinute: true,
        ...
        setup: function() {
            ...
            if (this.get("needTime")) {
                ...
                var html = Handlebars.compile(require("kjui/calendar/1.0.0/time-debug.tpl"))({
